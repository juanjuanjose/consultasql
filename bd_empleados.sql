...
select distinct codigo departamento from empleado ;                                                                                                                                                                    
...
SELECT apellido1, IFNULL(apellido2, ''), nombre FROM empleado ORDER BY apellido1 ASC, apellido2 ASC, nombre ASC;
